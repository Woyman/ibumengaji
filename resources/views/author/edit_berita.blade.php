        ...
        <div class="well well-info">
            ...
            <form action="{{ Route('editBerita') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_berita" class="form-control span6" value="{{ $berita[0]->judul_berita }}">
              </div>
              <div class="form-group">
                <label>Isi berita</label>
                <textarea id="beritaText" name="isi_berita"><?php echo $berita[0]->isi_berita ?></textarea>
              </div>
              <div class="form-group" style="margin-top: 20px">
                <label>Tanggal Upload Berita</label>
                <input type="text" name="tgl_upload" id="tgl_manual" class="form-control span4 datepicker" value="{{ $berita[0]->tgl_upload }}">
                ...
                <div class="row-fluid">
                 <div class="span6">
                  <label>Gambar/Foto</label>
                    ...
                    <small>*Pilih Gambar untuk mengganti gambar.</small>
                  </div>
                  <div>
                    <small>Gambar yang digunakan</small>
                    <img src="../../{{ $berita[0]->berita_img }}" width="300px">
                  </div> 
                </div>
